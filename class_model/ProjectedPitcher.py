...
def __convert_stat_player__(
    ...
    homeruns = __get_weighted_stat__(__get_closest_stats__(pitcher_stats_for_players["mov"][player.throws], player.mov_ovr),
        __get_weighted_formula__(projected_pitching_formulas.get_homeruns_per_mod_pa(player.bats, player.mov_vl), projected_pitching_formulas.get_homeruns_per_mod_pa(player.bats, player.mov_vr), vlhb_pct=vlhb_pct)) * (bf - hbp)
    strikeouts = __get_weighted_stat__(__get_closest_stats__(pitcher_stats_for_players["stu"][player.throws], player.stu_ovr),
        __get_weighted_formula__(projected_pitching_formulas.get_strikeouts_per_pa(player.throws, player.stu_vl), projected_pitching_formulas.get_strikeouts_per_pa(player.throws, player.stu_vr), vlhb_pct=vlhb_pct)) * (bf - hbp - homeruns)
    walks = __get_weighted_stat__(__get_closest_stats__(pitcher_stats_for_players["ctl"][player.throws], player.ctl_ovr),
        __get_weighted_formula__(projected_pitching_formulas.get_walks_per_mod_pa(player.bats, player.ctl_vl), projected_pitching_formulas.get_walks_per_mod_pa(player.bats, player.ctl_vr), vlhb_pct=vlhb_pct)) * (bf - hbp - homeruns - strikeouts)
    ...
    caught_stealing = __get_weighted_stat__(__get_closest_stats__(pitcher_stats_for_players["cs"], player.hold), projected_pitching_formulas.get_caught_stealing_per_steal(player.hold)) * stolen_base_attempts
